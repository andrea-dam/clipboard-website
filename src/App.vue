<template>
    ...
    <section
        ...
        <div class="section-container mb-40 px-10 pt-16">
            ...
            <p class="section-content mb-10">
                ...
                Instantly access your clipboardon all your devices.
            </p>
            <!-- Button Container -->
    ...
    <section id="snippets">
        <div class="section-container my-20">
            ...
            <p class="section-content mb-24">
                ...
                meaning you can access your snippets immediately on all you
            ...
            <div class="relative flex flex-col md:flex-row md:space-x-32">
                ...
                <div class="md:w-1/2">
                    <img
                        ...
                        alt=""
                        class="top-0 right-[50%] md:absolute" />
                </div>
                <!-- Items Container -->
                <div
    ...
    <section id="access">
        <div class="section-container my-20">
            ...
            <p class="section-content mb-24">
                Wheter you're on the go, or at your computer, you can access all
                your Clipboard snippets in a few single clicks.
            </p>
    ...
    <section id="references">
        <div
            class="mx-auto my-44 flex max-w-6xl flex-col items-center justify-between space-y-16 px-10 md:flex-row md:space-y-0">
    ...
    <section id="bottom">
        <div class="section-container my-20">
            ...
            <p class="section-content">
                ...
                synch with iCloud and you're ready to start adding to your
                clipboard.
            </p>
            <!-- Button Container -->
        ...
        <div class="section-container">
            <div class="flex flex-col items-center justify-between md:flex-row">
                ...
                <div
                    ...
                    <!-- Menus -->
                    <div
                        class="flex flex-col space-y-4 md:ml-24 md:flex-row md:space-x-24 md:space-y-0">
                        <!-- Menu 1 -->
                        <div
